...
@Component("aliSourceV2")
public class AliSourceV2 implements ISource, Closeable {
	private static final Logger log = Logger.getLogger(AliSourceV2.class);
	...
	public String getContent(Set<String> securities) throws IOException {
		...
		HttpGet httpGet = new HttpGet("https://alirmcom2.market.alicloudapi.com/query/comrms?symbols=" + symbol);
	...
	public static void main(String[] args) throws IOException {
		try(AliSourceV2 source = new AliSourceV2()){
